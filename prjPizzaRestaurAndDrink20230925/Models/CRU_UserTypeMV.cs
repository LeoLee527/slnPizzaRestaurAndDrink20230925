...
namespace prjPizzaRestaurAndDrink20230925.Models
{
    public class CRU_UserTypeMV
    {
        public CRU_UserTypeMV()
        {
            ...
            foreach (var usertype in new PizzaRestaurantAndDrinkDbEntities().UserTypeTables.ToList())
            {
        ...
        public CRU_UserTypeMV(int? id)
        {
            ...
            var editusertype = new PizzaRestaurantAndDrinkDbEntities().UserTypeTables.Where(u => u.UserTypeID == id).FirstOrDefault();
